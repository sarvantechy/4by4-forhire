...
| Backend application | Production deployed | Release `20260920212526` is healthy on the isolated For Hire EC2 service. Account deactivation/anonymization, session revocation, inventory hiding, and public privacy/deletion pages are deployed. No-OTP direct registration is explicitly enabled for Internal Testing through 2026-12-31; production OTP/email must replace it before expiry. |
