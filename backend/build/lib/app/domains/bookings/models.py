...
class Offer(Base):
    """A renter's negotiated price proposal for an item or service listing."""
    ...
    fulfillment_method: Mapped[str] = mapped_column(String(20), nullable=False)
    proposed_amount_minor: Mapped[int] = mapped_column(Integer, nullable=False)
    currency: Mapped[str] = mapped_column(String(3), nullable=False, default="INR")
    reason: Mapped[str] = mapped_column(String(1000), nullable=False)
    status: Mapped[str] = mapped_column(String(24), nullable=False, default="pending")
    counter_amount_minor: Mapped[int | None] = mapped_column(Integer)
    counter_reason: Mapped[str | None] = mapped_column(String(1000))
