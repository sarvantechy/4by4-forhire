...
class EmailDirectRegisterRequest(BaseModel):
    """Create or sign in to an account without an OTP round trip (dev only)."""
...
class MobileDirectRegisterRequest(BaseModel):
    """Create or sign in to an account without an OTP round trip (dev only)."""
